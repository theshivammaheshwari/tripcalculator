...
import { PlusCircle, Receipt, Users, Wallet, DollarSign, ArrowRight, ArrowRightLeft, Pencil, Trash2, X, UserPlus, Home, User, Users2, Coffee, Phone, Mail, Instagram, Facebook, Linkedin } from 'lucide-react';
...
const Index = () => {
  ...
  const calculateFinalSettlements = () => {
    ...
    people.forEach(person => {
      const belongsToFamily = familyHeads[person];
      const isFamilyHead = families[person];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          ...
          <button
            ...
            className="mt-4 md:mt-0 flex items-center gap-2 bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-6 py-3 rounded-full transform transition-all duration-300 hover:scale-105 shadow-lg"
          >
        ...
        <footer className="mt-16 bg-white rounded-xl shadow-lg p-8">
          <div className="text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl mx-auto mb-8">
              ...
              >
                ...
                <span className="text-gray-700">+91 9468955596</span>
              </a>
              <a 
              ...
              >
                ...
                <span className="text-gray-700">247shivam@gmail.com</span>
              </a>
            </div>
            ...
            <div className="flex justify-center gap-8">
              ...
              >
                <div className="p-3 rounded-full bg-gradient-to-br from-pink-500 to-purple-500 text-white transform transition-transform group-hover:scale-110">
              ...
              <a 
                ...
                className="group flex flex-col items-center gap-2"
              >
                <div className="p-3 rounded-full bg-blue-600 text-white transform transition-transform group-hover:scale-110">
              ...
              <a 
                ...
                className="group flex flex-col items-center gap-2"
              >
                <div className="p-3 rounded-full bg-blue-700 text-white transform transition-transform group-hover:scale-110">
